...
namespace transpa.api.generated.Model
{
    ...
    public partial class Employee : IEquatable<Employee>, IValidatableObject
    {
        ...
        public Employee(long id = default(long), string firstName = default(string), string lastName = default(string), long? employeeNumber = default(long?), string signature = default(string), bool isActive = default(bool))
        {
            this.Id = id;
