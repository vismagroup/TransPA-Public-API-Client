...
namespace transpa.api.generated.Model
{
    ...
    public partial class Salary : IEquatable<Salary>, IValidatableObject
    {
        ...
        public Salary(string id = default(string), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), string employeeId = default(string), List<WageRow> wageRows = default(List<WageRow>), List<TimeRow> timeRows = default(List<TimeRow>))
        {
            this.Id = id;
        ...
        public List<WageRow> WageRows { get; set; }

        /// <summary>
        /// Gets or Sets TimeRows
        /// </summary>
        [DataMember(Name = "timeRows", EmitDefaultValue = false)]
        public List<TimeRow> TimeRows { get; set; }
