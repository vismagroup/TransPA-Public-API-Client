...
namespace transpa.api.generated.Model
{
    ...
    /// VehicleGroup
    /// </summary>
    [DataContract(Name = "vehicleGroup")]
    public partial class VehicleGroup : IEquatable<VehicleGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleGroup" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public VehicleGroup(string id = default(string), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as VehicleGroup);
        }

        /// <summary>
        /// Returns true if VehicleGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleGroup input)
        {
            if (input == null)
                return false;
