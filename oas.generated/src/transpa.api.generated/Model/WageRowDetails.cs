...
namespace transpa.api.generated.Model
{
    ...
    /// WageRowDetails
    /// </summary>
    [DataContract(Name = "wageRow_details")]
    public partial class WageRowDetails : IEquatable<WageRowDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WageRowDetails" /> class.
        /// </summary>
        /// <param name="fromDate">fromDate.</param>
        /// <param name="toDate">toDate.</param>
        /// <param name="quantity">Number expressed as a decimal number.</param>
        /// <param name="unitPrice">unitPrice.</param>
        public WageRowDetails(DateTime fromDate = default(DateTime), DateTime toDate = default(DateTime), decimal quantity = default(decimal), Money unitPrice = default(Money))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WageRowDetails {\n");
        ...
        {
            return this.Equals(input as WageRowDetails);
        }

        /// <summary>
        /// Returns true if WageRowDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of WageRowDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WageRowDetails input)
        {
            if (input == null)
                return false;
