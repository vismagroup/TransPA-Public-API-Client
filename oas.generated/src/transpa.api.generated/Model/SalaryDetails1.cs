...
namespace transpa.api.generated.Model
{
    ...
    /// SalaryDetails1
    /// </summary>
    [DataContract(Name = "salary_details_1")]
    public partial class SalaryDetails1 : IEquatable<SalaryDetails1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalaryDetails1" /> class.
        /// </summary>
        /// <param name="fromDate">fromDate.</param>
        /// <param name="toDate">toDate.</param>
        /// <param name="quantity">Number expressed as a decimal number.</param>
        public SalaryDetails1(DateTime fromDate = default(DateTime), DateTime toDate = default(DateTime), decimal quantity = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalaryDetails1 {\n");
        ...
        {
            return this.Equals(input as SalaryDetails1);
        }

        /// <summary>
        /// Returns true if SalaryDetails1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SalaryDetails1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalaryDetails1 input)
        {
            if (input == null)
                return false;
