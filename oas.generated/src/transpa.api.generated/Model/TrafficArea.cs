...
namespace transpa.api.generated.Model
{
    ...
    /// TrafficArea
    /// </summary>
    [DataContract(Name = "trafficArea")]
    public partial class TrafficArea : IEquatable<TrafficArea>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrafficArea" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public TrafficArea(string id = default(string), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as TrafficArea);
        }

        /// <summary>
        /// Returns true if TrafficArea instances are equal
        /// </summary>
        /// <param name="input">Instance of TrafficArea to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrafficArea input)
        {
            if (input == null)
                return false;
