...
namespace transpa.api.generated.Model
{
    ...
    /// TimeRowDetails
    /// </summary>
    [DataContract(Name = "timeRow_details")]
    public partial class TimeRowDetails : IEquatable<TimeRowDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeRowDetails" /> class.
        /// </summary>
        /// <param name="fromDate">fromDate.</param>
        /// <param name="toDate">toDate.</param>
        /// <param name="quantity">Number expressed as a decimal number.</param>
        public TimeRowDetails(DateTime fromDate = default(DateTime), DateTime toDate = default(DateTime), decimal quantity = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimeRowDetails {\n");
        ...
        {
            return this.Equals(input as TimeRowDetails);
        }

        /// <summary>
        /// Returns true if TimeRowDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeRowDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeRowDetails input)
        {
            if (input == null)
                return false;
