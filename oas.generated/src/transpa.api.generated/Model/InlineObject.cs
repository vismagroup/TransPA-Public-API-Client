...
namespace transpa.api.generated.Model
{
    ...
    public partial class InlineObject : IEquatable<InlineObject>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="createCallbackUrl">createCallbackUrl.</param>
        public InlineObject(string createCallbackUrl = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "createCallbackUrl", EmitDefaultValue = false)]
