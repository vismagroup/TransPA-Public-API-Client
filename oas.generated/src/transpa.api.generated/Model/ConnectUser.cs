...
namespace transpa.api.generated.Model
{
    ...
    /// ConnectUser
    /// </summary>
    [DataContract(Name = "connectUser")]
    public partial class ConnectUser : IEquatable<ConnectUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectUser" /> class.
        /// </summary>
        /// <param name="connectId">connectId.</param>
        public ConnectUser(string connectId = default(string))
        {
        ...
        {
            return this.Equals(input as ConnectUser);
        }

        /// <summary>
        /// Returns true if ConnectUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectUser input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ConnectId == input.ConnectId ||
                    (this.ConnectId != null &&
                    this.ConnectId.Equals(input.ConnectId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConnectId != null)
                    hashCode = hashCode * 59 + this.ConnectId.GetHashCode();
                return hashCode;
            }
        }
