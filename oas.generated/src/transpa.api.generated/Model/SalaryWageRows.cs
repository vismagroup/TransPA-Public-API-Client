...
namespace transpa.api.generated.Model
{
    ...
    /// SalaryWageRows
    /// </summary>
    [DataContract(Name = "salary_wageRows")]
    public partial class SalaryWageRows : IEquatable<SalaryWageRows>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalaryWageRows" /> class.
        /// </summary>
        /// <param name="payTypeCode">payTypeCode.</param>
        /// <param name="unitPrice">unitPrice.</param>
        /// <param name="quantity">Number expressed as a decimal number.</param>
        /// <param name="details">details.</param>
        public SalaryWageRows(string payTypeCode = default(string), Money unitPrice = default(Money), decimal quantity = default(decimal), List<SalaryDetails> details = default(List<SalaryDetails>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalaryWageRows {\n");
        ...
        {
            return this.Equals(input as SalaryWageRows);
        }

        /// <summary>
        /// Returns true if SalaryWageRows instances are equal
        /// </summary>
        /// <param name="input">Instance of SalaryWageRows to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalaryWageRows input)
        {
            if (input == null)
                return false;
