...
namespace transpa.api.generated.Model
{
    ...
    /// TimeRow
    /// </summary>
    [DataContract(Name = "timeRow")]
    public partial class TimeRow : IEquatable<TimeRow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeRow" /> class.
        /// </summary>
        /// <param name="payTypeCode">payTypeCode.</param>
        /// <param name="details">details.</param>
        public TimeRow(string payTypeCode = default(string), List<TimeRowDetails> details = default(List<TimeRowDetails>))
        {
        ...
        public List<TimeRowDetails> Details { get; set; }
        ...
        {
            return this.Equals(input as TimeRow);
        }

        /// <summary>
        /// Returns true if TimeRow instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeRow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeRow input)
        {
            if (input == null)
                return false;
