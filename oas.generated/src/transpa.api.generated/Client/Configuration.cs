...
namespace transpa.api.generated.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.mytranspa.com/publicApi";
            ...
            Servers = new List<IReadOnlyDictionary<string, object>>()
            {
                ...
                {
                    new Dictionary<string, object> {
                        {"url", "https://mock.api.mytranspa.com/publicApi"},
                        {"description", "No description provided"},
                    }
                }
            };
        ...
        public Configuration(
            ...
            string basePath = "https://api.mytranspa.com/publicApi") : this()
        {
        ...
        {
            string report = "C# SDK (transpa.api.generated) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 0.1.21\n";
