...
namespace transpa.api.generated.Api
{
    ...
    /// </summary>
    public interface ITrafficAreasApiSync : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse2003> GetTrafficareasWithHttpInfo();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITrafficAreasApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2003> GetTrafficareasAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2003>> GetTrafficareasWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITrafficAreasApi : ITrafficAreasApiSync, ITrafficAreasApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TrafficAreasApi : ITrafficAreasApi
    {
        private transpa.api.generated.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TrafficAreasApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TrafficAreasApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TrafficAreasApi(string basePath)
        {
        ...
        /// <returns></returns>
        public TrafficAreasApi(transpa.api.generated.Client.Configuration configuration)
        {
        ...
        public TrafficAreasApi(transpa.api.generated.Client.ISynchronousClient client, transpa.api.generated.Client.IAsynchronousClient asyncClient, transpa.api.generated.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Return a list of Traffic Areas Required scope transpaapi:trafficareas:read 
        /// </summary>
        /// <exception cref="transpa.api.generated.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>InlineResponse2003</returns>
        public InlineResponse2003 GetTrafficareas()
        {
            transpa.api.generated.Client.ApiResponse<InlineResponse2003> localVarResponse = GetTrafficareasWithHttpInfo();
        ...
        /// <exception cref="transpa.api.generated.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of InlineResponse2003</returns>
        public transpa.api.generated.Client.ApiResponse<InlineResponse2003> GetTrafficareasWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<InlineResponse2003>("/v1/trafficAreas", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTrafficareas", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2003</returns>
        public async System.Threading.Tasks.Task<InlineResponse2003> GetTrafficareasAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            transpa.api.generated.Client.ApiResponse<InlineResponse2003> localVarResponse = await GetTrafficareasWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2003)</returns>
        public async System.Threading.Tasks.Task<transpa.api.generated.Client.ApiResponse<InlineResponse2003>> GetTrafficareasWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse2003>("/v1/trafficAreas", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
